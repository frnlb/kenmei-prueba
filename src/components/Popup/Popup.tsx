...
const Popup = ({ title, content, button, children }: PopupProps) => {
  return (
    <div>
      ...
      <div className="absolute top-1/4 left-0 right-0 z-50 mx-auto transform overflow-hidden rounded-lg bg-slate-100 px-4 pt-5 pb-4 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-sm sm:p-6">
        <div>{children}</div>
